...
<template>
    <div>
        <div class="min-h-screen bg-gray-100 dark:bg-gray-950">
                            ...
                            <button
                                @click="
                                    showingNavigationDropdown =
                                        !showingNavigationDropdown
                                "
                                class="inline-flex items-center justify-center rounded-md p-2 text-gray-400 transition duration-150 ease-in-out hover:bg-gray-100 hover:text-gray-500 focus:bg-gray-100 focus:text-gray-500 focus:outline-none dark:hover:bg-gray-800 dark:hover:text-gray-300 dark:focus:bg-gray-800"
                            >
                                <svg
                                    class="h-6 w-6"
                                    stroke="currentColor"
            ...
            <!-- Page Heading -->
            <header
                class="bg-white shadow dark:border-b dark:border-gray-800 dark:bg-gray-900 dark:shadow-none"
                v-if="$slots.header"
            >
