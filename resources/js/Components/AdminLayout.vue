...
<template>
    <div class="min-h-dvh bg-gray-50 text-gray-900 dark:bg-gray-950 dark:text-gray-100">
        ...
        >
            ...
            >
                <Link :href="route('admin.dashboard')" class="text-lg font-bold text-gray-900 dark:text-white">
                    DevKnowledge
                </Link>
                <div class="flex flex-wrap items-center gap-2 md:gap-3">
                    ...
                    <button
                        v-if="deferredPrompt"
                        type="button"
                        class="inline-flex rounded-lg border border-gray-300 px-3 py-2 text-xs font-semibold text-gray-700 hover:bg-gray-50 dark:border-gray-600 dark:text-gray-200 dark:hover:bg-gray-800"
                        @click="installPwa"
                    >
                        Programmany gurna
                    </button>
